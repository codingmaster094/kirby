...
$searchHelp = (string) $page->searchHelp()->or(
    'Tap a suggestion below — for example Belly fat, Knee pain, or Improve stamina. We’ll show which exercises to do, how many sets/reps, and how to do each move step by step.'
)->value();
?>
